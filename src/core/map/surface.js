...
MapSurface.prototype.parseJson = function(json) {
    ...
    this.pipeline = this.map.config.mapForcePipeline ? this.map.config.mapForcePipeline : (json['pipeline']); // || PIPELINE_HMAP);//PIPELINE_BASIC);
    //this.pipeline = json['pipeline'] || PIPELINE_BASIC;
