...
- RFC 1 [rfc1-config-store.md](rfc1-config-store.md) — single
  ...
  2026-07-13
- RFC 2 [rfc2-event-bus.md](rfc2-event-bus.md) — typed
  ...
  2026-07-11
- RFC 9
  [rfc9-metadata-first-traversal.md](rfc9-metadata-first-traversal.md) —
...
- RFC 7 [rfc7-metanode-store.md](rfc7-metanode-store.md) — precomputed
...
- RFC 3 [rfc3-draw-traversal.md](rfc3-draw-traversal.md) — unified
...
- RFC 6 [rfc6-map-frame.md](rfc6-map-frame.md) — moved the per-frame
...
- RFC 5 [rfc5-remove-3dtiles.md](rfc5-remove-3dtiles.md) — removed the
  OGC 3D Tiles / VTS octree pipeline and the removable legacy tile
  shader family (`drawSubmesh`, `progTile*`); implemented 2026-05-23
- RFC 4 [rfc4-bump-bake.md](rfc4-bump-bake.md) — collapse bump layers
