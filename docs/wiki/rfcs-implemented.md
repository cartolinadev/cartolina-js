...
- RFC 1 [rfc-config-store.md](rfc-config-store.md) — single
  ...
  public `setParam` / `getParam` and factory-option boundaries over
  the deliberate, consumer-audited `PublicRuntimeConfig` and
  `PublicConstructionConfig` subsets; implemented 2026-07-11
