...
- RFC 1 [rfc-config-store.md](rfc-config-store.md) — single
  ...
  (`core.js` deleted, typed public boundaries); steps 7–10 accepted to
  collapse the per-key artifacts into a single spec catalogue deriving
  types, defaults, normalization, public subsets, URL parsing, and
